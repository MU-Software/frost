...
class Config:
    ...
    SIGNIN_POSSIBLE_AFTER_MAIL_VERIFICATION = os.environ.get("SIGNIN_POSSIBLE_AFTER_MAIL_VERIFICATION", True) != "false"
...
class DevelopmentConfig(Config):
    ...
    LOCAL_DEV_CLIENT_PORT = (
        int(os.environ.get("LOCAL_DEV_CLIENT_PORT")) if os.environ.get("LOCAL_DEV_CLIENT_PORT") else None
    )
