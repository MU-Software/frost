...
class UserResponseModel(api_class.ResponseDataModel):
    ...
    refresh_token: dict = dataclasses.field(
        default_factory=lambda: {
            "exp": 0,
        }
    )
    access_token: dict = dataclasses.field(
        default_factory=lambda: {
            "exp": 0,
            "token": "",
        }
...
class AccountResponseCase(api_class.ResponseCaseCollector):
    ...
    user_not_found = api_class.Response(
        description="We cannot find any users", code=404, success=False, public_sub_code="user.not_found"
    )
    ...
    user_signed_up = api_class.Response(  # User signing up success
        ...
        data={
            "user": UserResponseModel.get_model_openapi_description(),
            "db": "",
        },
    )
    ...
    password_changed = api_class.Response(
        description="Successfully changed user's password.", code=200, success=True, public_sub_code="password.changed"
    )
    ...
    email_token_not_given_html = api_class.Response(
        ...
        template_path="email_action/error/email_token_not_given.html",
    )
    email_expired_html = api_class.Response(
        ...
        success=False,
        content_type="text/html",
        template_path="email_action/error/email_token_expired.html",
    )
    email_invalid_html = api_class.Response(
        ...
        success=False,
        content_type="text/html",
        template_path="email_action/error/email_token_invalid.html",
    )
    email_not_found_html = api_class.Response(
        ...
        success=False,
        content_type="text/html",
        template_path="email_action/error/email_token_not_found.html",
    )
    email_success_html = api_class.Response(
        ...
        success=True,
        content_type="text/html",
        template_path="email_action/email_action_success.html",
    )
    ...
    access_token_invalid = api_class.Response(
        description="Access token is invalid.", code=401, success=False, public_sub_code="access_token.invalid"
    )
