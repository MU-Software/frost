...
class CommonResponseCase(api_class.ResponseCaseCollector):
    ...
    http_ok = api_class.Response(
        description="Normal plane HTTP OK response", code=200, success=True, public_sub_code="http.ok"
    )
    ...
    http_not_found = api_class.Response(
        description="Route not found", code=404, success=False, public_sub_code="http.not_found"
    )
...
class ResourceResponseCase(api_class.ResponseCaseCollector):
    ...
    resource_deleted = api_class.Response(  # Delete
        description="Resource deleted", code=204, success=True, public_sub_code="resource.deleted"
    )
